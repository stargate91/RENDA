...
export const SERIES_VARS = ['SeriesTitle', 'SeriesOriginalTitle', 'FirstAirDate', 'LastAirDate', 'FirstAirYear', 'LastAirYear', 'SeriesSeasonCount', 'SeriesEpisodeCount', 'SeriesStatus', 'SeriesType', 'Networks', 'Resolution', 'Director', 'SeriesTmdbId', 'SeriesImdbId', 'SeriesRatingImdb', 'Custom'];
